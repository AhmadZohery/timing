...
export const DOMAIN_PRESETS: Record<ProfessionDomain, DomainPreset> = {
  ...
  data_ai: {
    ...
    icon: '🤖',
    roleExamples: ['AI Engineer', 'Data Scientist', 'MLOps', 'Data Analyst'],
    weekdayTasks: [
      { title: 'تدريب وتحسين النموذج (Model Training & Tuning)', durationMin: 45, category: 'deep_work' },
      { title: 'تنظيف وتحليل البيانات (EDA & Preprocessing)', durationMin: 35, category: 'data' },
      { title: 'كتابة واختبار الـ Pipelines', durationMin: 30, category: 'pipeline' },
      { title: 'متابعة مقاييس الأداء (Metrics & Evaluation)', durationMin: 20, category: 'eval' },
    ],
    halfDayTasks: [
      { title: 'توثيق التجارب ومراجعة الـ Experiments', durationMin: 25, category: 'docs' },
      { title: 'تنظيف مساحات التخزين والـ Datasets', durationMin: 20, category: 'tidy' },
    ],
    restDayIdeas: [
      'الابتعاد عن التفكير الحسابي والشاشات',
      'المشي في الطبيعة والاسترخاء',
    ],
  },
  product_management: {
    domain: 'product_management',
    titleAr: 'إدارة المنتجات الرقمية',
    titleEn: 'Product Management',
    icon: '🚀',
    roleExamples: ['Product Manager', 'Product Owner', 'Scrum Master'],
    weekdayTasks: [
      { title: 'كتابة PRD وتحديد متطلبات الميزة', durationMin: 40, category: 'prd' },
      { title: 'مراجعة مؤشرات الأداء ولوحة التحليلات', durationMin: 25, category: 'analytics' },
      { title: 'مزامنة الأولويات مع الفريق التقني', durationMin: 30, category: 'alignment' },
      { title: 'مقابلات واستبيانات المستخدمين', durationMin: 30, category: 'user_research' },
    ],
    halfDayTasks: [
      { title: 'ترتيب وتصفية الباك لوج (Backlog Grooming)', durationMin: 25, category: 'backlog' },
      { title: 'مشاركة ملخص الإنجاز الأسبوعي مع الإدارة', durationMin: 20, category: 'reporting' },
    ],
    restDayIdeas: [
      'قراءة حرة في مجالات بعيدة عن الإدارة والتقنية',
      'يوم عائلي ممتع واستراحة ذهنية كاملة',
    ],
  },
  content_marketing: {
    domain: 'content_marketing',
    titleAr: 'صناعة المحتوى والتسويق',
    titleEn: 'Content & Marketing',
    icon: '✍️',
    roleExamples: ['Content Creator', 'SEO Specialist', 'Copywriter', 'Growth Marketer'],
    weekdayTasks: [
      { title: 'كتابة مقال أو سكريبت فيديو جديد', durationMin: 45, category: 'writing' },
      { title: 'تحليل أداء الحملات والـ SEO', durationMin: 25, category: 'seo' },
      { title: 'جدولة المنشورات والتفاعل مع الجمهور', durationMin: 20, category: 'social' },
      { title: 'عصف ذهني لأفكار محتوى الأسبوع', durationMin: 30, category: 'brainstorming' },
    ],
    halfDayTasks: [
      { title: 'جدولة المنشورات للأسبوع القادم', durationMin: 25, category: 'scheduling' },
      { title: 'مراجعة التقارير الشهرية ومؤشرات النمو', durationMin: 20, category: 'analytics' },
    ],
    restDayIdeas: [
      'الابتعاد الكامل عن منصات التواصل الاجتماعي',
      'القراءة في كتاب ورقي للاستمتاع والسكينة',
    ],
  },
  finance_trading: {
    domain: 'finance_trading',
    titleAr: 'المالية والاستثمار والتداول',
    titleEn: 'Finance & Trading',
    icon: '📈',
    roleExamples: ['Financial Analyst', 'Trader', 'Accountant', 'Investor'],
    weekdayTasks: [
      { title: 'تحليل حركة الأسواق والتقارير المالية', durationMin: 40, category: 'analysis' },
      { title: 'إدارة وتدقيق المحفظة وإدارة المخاطر', durationMin: 30, category: 'risk' },
      { title: 'إعداد التقارير المالية والتدفقات النقدية', durationMin: 35, category: 'reporting' },
      { title: 'متابعة الأخبار الاقتصادية ومؤشرات التضخم', durationMin: 20, category: 'news' },
    ],
    halfDayTasks: [
      { title: 'إغلاق ومراجعة صفقات وحسابات الأسبوع', durationMin: 25, category: 'reconciliation' },
      { title: 'تحديث سجل الأداء المالي الشخصي', durationMin: 20, category: 'tracking' },
    ],
    restDayIdeas: [
      'إغلاق شاشات الأسعار والرسوم البيانية تماماً',
      'ممارسة رياضة الجري أو السباحة لتفريغ التوتر',
    ],
  },
  engineering_architecture: {
    domain: 'engineering_architecture',
    titleAr: 'الهندسة المعمارية والمدنية',
    titleEn: 'Engineering & Architecture',
    icon: '📐',
    roleExamples: ['Architect', 'Civil Engineer', 'Project Engineer', 'BIM Specialist'],
    weekdayTasks: [
      { title: 'الرسم الهندسي والنمذجة (AutoCAD / Revit)', durationMin: 45, category: 'modeling' },
      { title: 'مراجعة الحسابات الإنشائية والمخططات', durationMin: 35, category: 'calc' },
      { title: 'متابعة كود البناء والمواصفات القياسية', durationMin: 25, category: 'compliance' },
      { title: 'إعداد جداول الكميات والمواصفات', durationMin: 30, category: 'boq' },
    ],
    halfDayTasks: [
      { title: 'أرشفة المخططات ونسخ الملفات السحابية', durationMin: 20, category: 'archive' },
      { title: 'متابعة تقارير الزيارات الميدانية والموقع', durationMin: 25, category: 'site' },
    ],
    restDayIdeas: [
      'التأمل في العمارة التراثية أو الطبيعة',
      'راحة جسدية بعد العمل المكتبي والميداني',
    ],
  },
  law_legal: {
    domain: 'law_legal',
    titleAr: 'القانون والاستشارات الشرعية والنظامية',
    titleEn: 'Law & Legal Advisory',
    icon: '⚖️',
    roleExamples: ['محامي', 'مستشار قانوني', 'باحث قانوني', 'موثق'],
    weekdayTasks: [
      { title: 'صياغة ومراجعة العقود والاتفاقيات', durationMin: 45, category: 'contracts' },
      { title: 'بحث السوابق القضائية والنصوص النظامية', durationMin: 35, category: 'research' },
      { title: 'كتابة المذكرات القانونية ولوائح الدعوى', durationMin: 40, category: 'briefs' },
      { title: 'متابعة جلسات الترافع والمواعيد الإجرائية', durationMin: 20, category: 'court' },
    ],
    halfDayTasks: [
      { title: 'تنظيم وتحديث ملفات القضايا المعلقة', durationMin: 25, category: 'files' },
      { title: 'مراجعة المهل والمواعيد القانونية للأسبوع المقبل', durationMin: 20, category: 'deadlines' },
    ],
    restDayIdeas: [
      'الراحة من النقاشات والجدل القانوني',
      'قضاء يوم عائلي هادئ وقراءة نصوص أدبية',
    ],
  },
  education_teaching: {
    domain: 'education_teaching',
    titleAr: 'التعليم والتدريس عن بعد والتدريب',
    titleEn: 'Education & Online Teaching',
    icon: '👨‍🏫',
    roleExamples: ['معلم', 'مدرس عن بعد', 'مدرب معتمد', 'محاضر'],
    weekdayTasks: [
      { title: 'تحضير الشرائح والمادة التعليمية التفاعلية', durationMin: 40, category: 'prep' },
      { title: 'تقديم الحصة / الجلسة التدريبية المباشرة', durationMin: 50, category: 'teaching' },
      { title: 'تصحيح الواجبات وتقديم التغذية الراجعة', durationMin: 30, category: 'grading' },
      { title: 'التواصل مع الطلاب وأولياء الأمور والإجابة على الأسئلة', durationMin: 20, category: 'support' },
    ],
    halfDayTasks: [
      { title: 'تحديث سجل درجات ومشاركات الطلاب', durationMin: 25, category: 'records' },
      { title: 'تنظيم مصادر ومراجع الدروس للأسبوع القادم', durationMin: 20, category: 'planning' },
    ],
    restDayIdeas: [
      'راحة الحبال الصوتية والاسترخاء الذهني',
      'ممارسة هواية شخصية بعيدة عن التدريس',
    ],
  },
  ecommerce_retail: {
    domain: 'ecommerce_retail',
    titleAr: 'التجارة الإلكترونية وإدارة المتاجر',
    titleEn: 'E-commerce & Retail',
    icon: '🛒',
    roleExamples: ['Store Owner', 'E-commerce Specialist', 'Supply Chain Analyst'],
    weekdayTasks: [
      { title: 'متابعة الطلبات وتنسيق الشحن والخدمات اللوجستية', durationMin: 35, category: 'fulfillment' },
      { title: 'تحديث بيانات المنتجات والأسعار والمخزون', durationMin: 30, category: 'catalog' },
      { title: 'إدارة خدمة العملاء والرد على الاستفسارات', durationMin: 25, category: 'support' },
      { title: 'تحسين حملات الإعلانات ومعدل التحويل (CRO)', durationMin: 35, category: 'growth' },
    ],
    halfDayTasks: [
      { title: 'جرد المبيعات والأرباح الأسبوعية للمتجر', durationMin: 25, category: 'reconciliation' },
      { title: 'مراجعة تقييمات العملاء وحل المشكلات المعلقة', durationMin: 20, category: 'reviews' },
    ],
    restDayIdeas: [
      'فصل التنبيهات التجارية واستعادة الهدوء النفسي',
      'الخروج في نزهة مفتوحة واستنشاق هواء نقي',
    ],
  },
  custom: {
    domain: 'custom',
